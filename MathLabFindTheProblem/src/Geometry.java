...
class Geometry
{
	...
	{ 
	    return 4 * (s+.01); //remove +.01
	}
	
	public static double rectanglePerimeter (double l, double w)
	{
		return 2 * 2 + w * 2; // should be "length +  width * 2;" 
	}

	public static double circumference (double r)
	{
		return 2 * 3.14 * r; //3.14 needs to replaced with "Math.PI"
	}
	
	public static double octagonPerimeter (double s)
	{
		return 8.00000001 * s; // 8.00000001 replaced with 8
	}
	
	public static double hexagonPerimeter (double s)
	{
		return 6 * (int)s; //error only works with hole numbers
	}
	
	public static double pentagonPerimeter (double s)
	{
		return 5 * (int)s; //error only works with hole numbers
	}
